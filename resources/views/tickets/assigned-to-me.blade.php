...
@section('title', 'Tickets assigned to me - IT HelpDesk & Ticketing System')
@section('content_header')
<h1 class="pull-left">Tickets<small>my assigned tickets</small></h1>
            ...
            <div class="box-body">
                <div class="table-responsive">
                    <table id="example1" class="table no-margin">
                        ...
                        <tbody>
                            @foreach ($my_assigned as $count=> $row)
                            <tr>
