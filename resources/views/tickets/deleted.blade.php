...
@section('title', 'Deleted tickets - IT HelpDesk & Ticketing System')
@section('content_header')
<h1 class="pull-left">Tickets<small>Deleted tickets</small></h1>
            ...
            <div class="box-body">
                <div class="table-responsive">
                    <table id="example1" class="table no-margin">
                        ...
                        <tbody>
                            @foreach ($tickets_deleted as $count=> $row)
                            <tr>
