<div class="modal fade" id="modal_delete_issue_category">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <p>Are you sure you want to delete issue category <span style="font-weight:bold">{{$issue->issue_name}}</span>?</p>
                    </div>
                </div>
            </div>
