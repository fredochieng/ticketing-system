<div class="modal fade" id="modal_work_on_ticket_{{$tickets->ticket_id}}">
    <div class="modal-dialog">
        <div class="modal-content">
            {!!
            Form::open(['action'=>['TicketController@workOnTicket',$tickets->ticket_id],'method'=>'POST','class'=>'floatit','enctype'=>'multipart/form-data'])
            !!}

            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Work On Ticket</h4>
            </div>
            <input type="hidden" name="ticket_id" value="{{$tickets->ticket_id}}">
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <p>Are you sure you want to work on ticket <span
