                                                    ...
                                                    <table border="0" width="100%" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="text center-text" valign="middle" align="left"
                                                                ...
                                                                Hello {{ $inputs['name'] }},<br /><br />

                                                                A new ticket has been created for your request.<br />
                                                                Ticket ID: <b>#{{ $inputs['ticket'] }}</b><br /><br />

                                                                {{ $inputs['message'] }}<br /><br />

                                                                You can reply to this email to add additional
                                                                information.<br />
                                                                Please do not remove the ticket number from the subject
                                                                line.<br /><br />
